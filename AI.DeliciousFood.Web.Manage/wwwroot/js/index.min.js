;jQuery( function() {
    ...
    var userConfig = {
        ...
        content: {
            target: '#iframe-content' // 用户只设置了 target
        }
    };
    // 合并用户配置和默认配置
    userConfig.content = $.extend({}, defaultContentConfig, userConfig.content);
    // 初始化 multitabs 插件
    $('#iframe-content').multitabs(userConfig);
    // 选项卡
    ...
    //        type : 'main',
    //        title : '首页',
    //        url : $('#default-page').attr('href') || 'lyear_main.html'
    //    }]
    //});
